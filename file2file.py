...
t_env.execute_sql("""
        CREATE TABLE mySource (
          ...
          'format' = 'csv',
          'path' = '/Users/opengs7/PycharmProjects/pyflink/pyflink-demo-master/example/data_input'
        )
    """)
...
t_env.execute_sql("""
        CREATE TABLE mySink (
          ...
          'connector' = 'filesystem',
          'format' = 'csv',
          'path' = '/Users/opengs7/PycharmProjects/pyflink/pyflink-demo-master/example/data/data_out'
        )
    """)
